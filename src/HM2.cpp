...
//}
//
//std::vector<float> HM2::InterpolationPolygon(const std::vector<float>& pos_x, const std::vector<float>& pos_y,
...
//}
//
//std::vector<float> HM2::ApproximationPolygon(const std::vector<float>& pos_x, const std::vector<float>& pos_y,
...
//}
//
//std::vector<float> HM2::CubicSpline(const std::vector<float>& pos_x, const std::vector<float>& pos_y,
//    float lb, float rb, float step) {
...
//
//std::vector<float>
//HM2::ParameterizationUniform(const std::vector<float>& pos_x, const std::vector<float>& pos_y) {
//    const size_t n = pos_x.size();
//    if (n == 1) {
//        return { 0.0f };
//    }
...
//
//std::vector<float>
//HM2::ParameterizationChoral(const std::vector<float>& pos_x, const std::vector<float>& pos_y) {
//    const size_t n = pos_x.size();
//    if (n == 1) {
//        return { 0.0f };
//    }
...
//
//std::vector<float>
//HM2::ParameterizationCentripetal(const std::vector<float>& pos_x, const std::vector<float>& pos_y) {
//    const size_t n = pos_x.size();
//    if (n == 1) {
//        return { 0.0f };
//    }
...
//
//std::vector<float>
//HM2::ParameterizationFoley(const std::vector<float>& pos_x, const std::vector<float>& pos_y) {
//    const size_t n = pos_x.size();
//    if (n == 1) {
//        return { 0.0f };
//    }
